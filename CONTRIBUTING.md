...
Feather is open-source, and **all contributions are welcome**.
...
### CI
Some [Github Actions](https://github.com/akmonengine/feather/tree/master/.github/workflows) are required:
...
## Issues
Feel free to open [issues](https://github.com/akmonengine/feather/issues) for bugs or improvements.
